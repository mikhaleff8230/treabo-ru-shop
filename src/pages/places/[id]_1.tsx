...
const PlaceDetailPage = ({ place: initialPlace, meta: initialMeta, error: initialError }: PlaceDetailProps) => {
  ...
  // Извлекаем URL из объектов изображений и видео
  const images: string[] = extractMediaUrls(place.images);
  const videos: string[] = extractMediaUrls(place.videos);
                  ...
                  <div className="border-t border-light-300 dark:border-dark-400 pt-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        <div className="w-8 h-8 rounded-full bg-light-300 dark:bg-dark-400 flex-shrink-0"></div>
                        <div className="flex-1">
                          <p className="text-sm text-dark dark:text-light">
                            <span className="font-semibold">{t('text-comments-placeholder')}</span> {t('text-comments-placeholder-desc')}
                          </p>
                        </div>
                      </div>
                    </div>
