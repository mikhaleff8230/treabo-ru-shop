  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-dark-100">
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h1 className="text-4xl lg:text-6xl font-bold text-light dark:text-light leading-tight">
              ...
              <div className="relative">
                <div className="w-full aspect-square max-w-md mx-auto relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-brand/20 to-brand-dark/20 rounded-3xl blur-3xl">
				  
				  <h1 className="text-4xl lg:text-6xl font-bold text-light dark:text-light leading-tight">
                 стоимость размещения всего 49 руб за товар на 6 месяцев.
                </h1>
        ...
        {/* Benefits Section */}
        <section className="bg-white dark:bg-dark-100 py-16" style={{ backgroundColor: 'rgba(212, 218, 170, 0.5)' }}>
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-16">
              ...
              <Card className="bg-white dark:bg-dark-300 border border-light-500 dark:border-dark-600 p-6 rounded-2xl">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-dark/60 dark:text-light/60">49 руб на 6 месяцев</p>
                </div>
              </Card>
              ...
              <Card className="bg-white dark:bg-dark-300 border border-light-500 dark:border-dark-600 p-6 rounded-2xl">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-dark/60 dark:text-light/60">бесплатно</p>
                </div>
              </Card>
              ...
              <Card className="bg-white dark:bg-dark-300 border border-light-500 dark:border-dark-600 p-6 rounded-2xl">
                <div className="space-y-2">
                  ...
                  <h3 className="text-xl font-bold text-dark dark:text-light">Ставьте ссылки из контента</h3>
                  <p className="text-sm text-dark/60 dark:text-light/60">плейс на товар, товар на маркетплейс Ozon/WB </p>
                </div>
              </Card>
            </div>
