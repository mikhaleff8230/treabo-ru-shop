...
export default function BottomNavigation() {
  ...
  return (
    <>
      ...
      <nav className="bottom-menu fixed bottom-0 left-0 right-0 z-30 grid h-14 w-full grid-cols-4 items-center justify-items-center text-center shadow-bottom-nav backdrop-blur-xl bg-light/90 dark:bg-dark-300/90 sm:hidden" style={{ margin: 0, padding: 0 }}>
        {/* Домой */}
        <Button
          variant="icon"
          aria-label="Home"
