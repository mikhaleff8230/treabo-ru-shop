            ...
            >
              {open && (
                <Disclosure.Panel static>
                  <div 
                    className="px-5 py-3 leading-7 space-y-3 3xl:px-6 3xl:pt-5 prose prose-sm max-w-none dark:prose-invert prose-ul:list-disc prose-ul:pl-5 prose-ul:space-y-2 prose-li:marker:text-dark dark:prose-li:marker:text-light"
