        ...
        >
          {gallery?.map((item: any) => (
            <SwiperSlide
              ...
              className="relative flex aspect-[1/1] items-center justify-center bg-light-200 dark:bg-dark-200"
            >
              <Image
                fill
        ...
        >
          {gallery?.map((item: any) => (
            <SwiperSlide
              ...
              className="relative flex aspect-[1/1] cursor-pointer items-center justify-center border border-light-500 transition hover:opacity-75 dark:border-dark-500"
              style={{
                width: 'auto',
                flexShrink: 0,
              }}
