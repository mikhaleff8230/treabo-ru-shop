...
export const jobCards = [
  {
    ...
    pay: '3 600 ₽',
    priceNote: 'Начальная цена',
    duration: '6 часов',
    tags: ['Выплата завтра', 'Без опыта'],
    icon: PackageCheck,
    photos: ['/proffi/task-preview-retail.svg', '/proffi/task-preview-courier.svg', '/proffi/task-preview-paint.svg'],
  },
  {
    ...
    icon: Wrench,
    photos: ['/proffi/task-preview-repair.svg', '/proffi/task-preview-paint.svg'],
  },
  {
    ...
    icon: Bike,
    photos: ['/proffi/task-preview-courier.svg', '/proffi/task-preview-retail.svg', '/proffi/task-preview-repair.svg'],
  },
  {
    ...
    icon: Paintbrush,
    photos: ['/proffi/task-preview-paint.svg', '/proffi/task-preview-repair.svg'],
  },
];
