export function CollectionIcon(props: React.SVGAttributes<{}>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
      ...
      {...props}
    >
      {/* Папка/коллекция - более жирная версия */}
      <path
      ...
      />
      {/* Документы внутри - более жирные */}
      <path
        d="M7 12H17M7 15H15M7 9H13"
        stroke="currentColor"
        strokeWidth="2.5"
        strokeLinecap="round"
        strokeLinejoin="round"
        fill="none"
      />
      {/* Второй документ для эффекта коллекции */}
      <path
        d="M5 9H15V19H5V9Z"
        fill="currentColor"
        fillOpacity="0.3"
