          ...
          <div>
            ...
            <HashtagAutocomplete
              ...
              onChange={(value) => {
                ...
                // ВАЖНО: Используем shouldDirty и shouldTouch для правильного обновления формы
                setValue('hashtags', value, { 
                  shouldValidate: true,
                  shouldDirty: true,
                  shouldTouch: true,
                });
                // Принудительно обновляем значение, чтобы watch() сразу получил новое значение
                // Это важно для реактивного обновления
